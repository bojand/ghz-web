...
// 2018-09-28 17:56:55.181454 -0300 ADT m=+4.565504425
        ...
        "api.DetailListResponse": {
            ...
            "properties": {
                "data": {
                    ...
                    "type": "array",
                    "items": {
                        "type": "\u0026{%!s(token.Pos=601) %!s(*ast.SelectorExpr=\u0026{0xc0004b39a0 0xc0004b39c0})}"
                    }
                },
                "total": {
                    "description": "The total number of details",
                    "type": "integer"
                }
            }
        },
