...
func TestTestModel_SetStatus(t *testing.T) {
	var tests = []struct {
		...
		}, 0.0, false, &Test{Status: StatusOK, FailOnError: false, Thresholds: map[Threshold]*ThresholdSetting{
		...
		{"mean over limit", &Test{Thresholds: map[Threshold]*ThresholdSetting{
			...
			milli1, milli2, milli3, milli4, milli4, milli4,
		}, 0.0, false, &Test{Status: StatusFail, FailOnError: false, Thresholds: map[Threshold]*ThresholdSetting{
		...
		{"fastest over limit", &Test{Thresholds: map[Threshold]*ThresholdSetting{
			ThresholdMean:    &ThresholdSetting{Threshold: milli5},
			ThresholdMedian:  &ThresholdSetting{Threshold: milli5},
			Threshold95th:    &ThresholdSetting{Threshold: milli5},
			Threshold99th:    &ThresholdSetting{Threshold: milli5},
		...
		{"slowest over limit", &Test{Thresholds: map[Threshold]*ThresholdSetting{
			ThresholdMean:    &ThresholdSetting{Threshold: milli5},
			ThresholdMedian:  &ThresholdSetting{Threshold: milli5},
			Threshold95th:    &ThresholdSetting{Threshold: milli5},
			Threshold99th:    &ThresholdSetting{Threshold: milli5},
		...
		{"RPS passed in 0", &Test{Thresholds: map[Threshold]*ThresholdSetting{
			ThresholdMean:    &ThresholdSetting{Threshold: milli5},
			ThresholdMedian:  &ThresholdSetting{Threshold: milli5},
			Threshold95th:    &ThresholdSetting{Threshold: milli5},
			Threshold99th:    &ThresholdSetting{Threshold: milli5},
		...
		{"RPS below limit", &Test{Thresholds: map[Threshold]*ThresholdSetting{
			ThresholdMean:    &ThresholdSetting{Threshold: milli5},
			ThresholdMedian:  &ThresholdSetting{Threshold: milli5},
			Threshold95th:    &ThresholdSetting{Threshold: milli5},
			Threshold99th:    &ThresholdSetting{Threshold: milli5},
			...
			milli1, milli2, milli3, milli4, milli4, milli4,
		}, 200.0, false, &Test{Status: StatusFail, FailOnError: false, Thresholds: map[Threshold]*ThresholdSetting{
			ThresholdMean:    &ThresholdSetting{Threshold: milli5, Status: StatusOK},
			ThresholdMedian:  &ThresholdSetting{Threshold: milli5, Status: StatusOK},
			Threshold95th:    &ThresholdSetting{Threshold: milli5, Status: StatusOK},
			Threshold99th:    &ThresholdSetting{Threshold: milli5, Status: StatusOK},
		...
		{"RPS above limit", &Test{Thresholds: map[Threshold]*ThresholdSetting{
			ThresholdMean:    &ThresholdSetting{Threshold: milli5},
			ThresholdMedian:  &ThresholdSetting{Threshold: milli5},
			Threshold95th:    &ThresholdSetting{Threshold: milli5},
			Threshold99th:    &ThresholdSetting{Threshold: milli5},
			...
			milli1, milli2, milli3, milli4, milli4, milli4,
		}, 2000.0, false, &Test{Status: StatusOK, FailOnError: false, Thresholds: map[Threshold]*ThresholdSetting{
			ThresholdMean:    &ThresholdSetting{Threshold: milli5, Status: StatusOK},
			ThresholdMedian:  &ThresholdSetting{Threshold: milli5, Status: StatusOK},
			Threshold95th:    &ThresholdSetting{Threshold: milli5, Status: StatusOK},
			Threshold99th:    &ThresholdSetting{Threshold: milli5, Status: StatusOK},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			actual := tt.model
			actual.SetStatus(tt.in[0], tt.in[1], tt.in[2], tt.in[3], tt.in[4], tt.in[5], tt.inNum, tt.inError)
